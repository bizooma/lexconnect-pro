...
function Onboarding() {
  ...
  const next = () => (step < STEPS.length - 1 ? setStep(step + 1) : navigate({ to: "/app/dashboard" }));
    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto w-full max-w-xl flex-1 px-5 py-8">
        ...
        {step === 1 && (
          <div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
              {[
                ["Full name", "Christopher Hale"],
                ["Law firm", "Hale & Associates"],
                ["City / State", "Austin, TX"],
                ["Years of experience", "8"],
                ["Bar associations", "Texas State Bar"],
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  {PRACTICE_AREAS.map((p) => <Chip key={p} label={p} />)}
                </div>
              </div>
            </div>
          </div>
        ...
        {step === 3 && (
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {["Messaging", "Voice Notes", "Video Calls", "Coffee Meetings"].map((c) => (
        ...
        {step === 4 && (
          <div>
            ...
            <textarea
              rows={6}
              defaultValue="Eight years in mid-market business litigation. Currently building a solo practice focused on commercial disputes. Looking to learn from senior trial counsel and mentor newer attorneys getting started in litigation."
      ...
      <footer className="sticky bottom-0 border-t border-border bg-background/95 px-5 py-4 backdrop-blur">
        <div className="mx-auto flex max-w-xl items-center justify-between gap-3">
          ...
          >{step === STEPS.length - 1 ? "Enter dashboard" : "Continue"}</button>
        </div>
      </footer>
    </div>
  );
