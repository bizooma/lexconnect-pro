...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BridgeTRUST Mentorship — Modern attorney mentorship" },
      ...
      { property: "og:title", content: "BridgeTRUST Mentorship" },
      { property: "og:description", content: "Modern attorney mentorship — relationships, scheduling, and lightweight messaging in one place." },
